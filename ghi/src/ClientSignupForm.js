              ...
              <div className="offset-3 col-6">
                <div className="shadow p-4 mt-4">
                  ...
                  <form onSubmit={handleSubmit} id="create-new-employee-form">
                    ...
                    <div className="form-floating mb-3">
                      <input onChange={handleStateChange} placeholder="state" required type="text" name="state" id="state" className="form-control" value={state} />
                      <label htmlFor="state">State</label>
                    </div>
                    <div className="form-floating mb-3">
                      <input onChange={handleZipCodeChange} placeholder="zipcode" required type="text" name="zipcode" id="zipcode" className="form-control" value={zipcode} />
                      <label htmlFor="zipcode">ZIP code</label>
                    </div>
                    <div className="form-floating mb-3">
                      <input onChange={handleAdditionalNotesChange} placeholder="additional_notes" required type="text" name="additional_notes" id="additional_notes" className="form-control" value={additional_notes} />
